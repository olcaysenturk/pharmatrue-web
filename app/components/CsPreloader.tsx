...
export function CsPreloader() {
  ...
  useEffect(() => {
    ...
    const hidePreloader = () => {
      setIsHidden(true);
      removalTimer = window.setTimeout(() => setIsRemoved(true), 900);
    };
  ...
  return (
    <div className={`cs_preloader${isHidden ? " cs_preloader--hidden" : ""}`}>
      <div
        className={`cs_preloader_in${
          isHidden ? " cs_preloader_in--hidden" : ""
        }`}
      >
